...
const Contact = () => {
  return (
    <div>
      <section class="min-h-screen bg-white dark:bg-[#1B1B1D]">
              ...
              <form class="mt-12">
                ...
                <Link to="/">
                 ...
                 text-white capitalize transition-colors duration-300 transform
                  bg-gradient-to-r from-[#38A1BB] from-14.72% via-[#38A1BB] via-77.9% to-[#604DBC] to-84.87% ... rounded-md hover:bg-blue-400 focus:outline-none 
